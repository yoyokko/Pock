...
struct KeyboardShortcutSender{
    ...
    init(keyCode: CGKeyCode, cmd: Bool, alt: Bool, ctrl: Bool, shift: Bool) {
        self.keyCode = keyCode
        self.cmdMask = cmd
        self.altMask = alt
        self.ctrlMask = ctrl
        self.shiftMask = shift
    }
    ...
    func press() {
        KeyboardShortcutSenderPress(keyCode, cmdMask, altMask, ctrlMask, shiftMask)
    }
    func release() {
    }
}
